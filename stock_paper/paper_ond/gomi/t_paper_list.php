...
#    print '<form method="post" action="../staff_login/staff_login.html"><input type="submit" value="ログイン" class="btn-shadow"></form>';
    print '<p><form method="post" action="../staff_login/staff_login_check.php"><input type="submit" value="ログイン" class="btn-shadow">　ID：<input type="text" name="staff_code">　パスワード：<input type="password" name="staff_pass">';
    print '　<a href="../paper/t_paper_list.php" class="btn-simple">用紙管理【色上質】</a></form></p>';
#    exit();
  } else {
    ...
    if($_SESSION['staff_kengen']=='管理'){
      ...
      print '　<a href="../paper/t_paper_list.php" class="btn-simple">用紙管理【色上質】</a></p>';
    } else {
      print '　<a href="../paper/t_paper_list.php" class="btn-simple">用紙管理【色上質】</a>';
      print '</p><br/>';
    }
  }
?>

<h1 class="f_clear">用紙管理【レザック】</h1>
