...
<?php
  if(isset($_SESSION['login'])==false){
    ...
    print '　<a href="../paper_ond/t_paper_list_ond.php" class="btn-simple">用紙管理【色上質（オンデマンド）】</a>';
    print '　<a href="../paper_ond/t_paper_list_ond_r.php" class="btn-simple">用紙管理【レザック（オンデマンド）】</a></p></form>';
    # exit();
  } else {
    ...
    if($_SESSION['staff_kengen']=='管理'){
      print '<br>';
      print '　<><a href="../staff/staff_list.php" class="btn-simple">スタッフ管理</a>';
      print '　<a href="./t_paper_list.php" class="btn-simple">用紙管理【色上質】</a>';
      print '　<a href="./t_paper_list_r.php" class="btn-simple">用紙管理【レザック】</a>';
      print '　<a href="../paper_ond/t_paper_list_ond.php" class="btn-simple">用紙管理【色上質（オンデマンド）】</a>';
      print '　<a href="../paper_ond/t_paper_list_ond.php" class="btn-simple">用紙管理【レザック（オンデマンド）】</a></p>';
    } else {
      print '<br>';
      print '　<><a href="./t_paper_list.php" class="btn-simple">用紙管理【色上質】</a>';
      print '　<a href="./t_paper_list_r.php" class="btn-simple">用紙管理【レザック】</a>';
...
<h1 class="f_clear">用紙管理【レザック、その他（オンデマンド）】</h1>
    ...
    <tbody>
        ...
        <tr>
          <form method="post" action="t_paper_sp_check.php">
            ...
            <td><input type="text" name="paper_atsusa" list="atsusa" placeholder="入力またはダブルクリック" style="width:6em;">
              <datalist id="atsusa">
                <option value="100（四六）">100（四六）</option>
                <option value="130（四六）">130（四六）</option>
                <option value="175（四六）">175（四六）</option>
                <option value="215（四六）">215（四六）</option>
                <option value="260（四六）">260（四六）</option>
                <option value="69.5（菊）">69.5（菊）</option>
                <option value="90（菊）">90（菊）</option>
                <option value="121.5（菊）">121.5（菊）</option>
              </datalist></td>
            ...
            <td><input type="text" name="paper_size" list="psize" placeholder="入力またはダブルクリック" style="width:6em;">
              <datalist id="psize">
                <option value="四六判８切">四六判８切</option>
                <option value="四六判５切">四六判５切</option>
            ...
            <td>
              <select name="paper_name" style="width:10em;">
            ...
            <td><select name="paper_me" style="width:6em;">
              ...
              <option value="Y">Ｙ</option></select>
            </td>
            <td>
              <input type="text" name="paper_number" style="width:6em;">
            </td>
            ...
            <td>
              <input type="submit" name="t_paper_sp_add" value="追加" class="btn-simple">
            </td>
          </form>
        </tr>
      <?php } ?>
      ...
      <?php
        try{
          ...
          $sql='SELECT p_code,p_color,p_atsusa,p_size,p_name,p_me,p_number,p_entryuser,p_entry FROM mst_paper WHERE p_name="レザック６６" OR p_name="レザック７５" OR p_name="レザック８０つむぎ" OR p_name="レザック８２ろうけつ" OR p_name="その他" ORDER BY p_color,p_name,p_atsusa,p_size,p_me ASC'; //用紙名昇順
          $stmt=$dbh->prepare($sql);
          $stmt->execute();
